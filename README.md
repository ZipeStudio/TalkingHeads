    ...
    <td style="vertical-align: top;">
      <div style="display: flex; flex-direction: column;">
        <div style="display: flex;">
          ...
          <a href="https://www.curseforge.com/minecraft/mc-mods/talkingheads">

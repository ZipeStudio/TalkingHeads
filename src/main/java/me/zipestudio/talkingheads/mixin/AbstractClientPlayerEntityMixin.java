...
public abstract class AbstractClientPlayerEntityMixin {
    ...
    @Unique
    private static final ResourceLocation TH_CAPE_ID = ResourceLocation.tryBuild(THServer.MOD_ID, "textures/cape/talking_heads_cape.png");
    ...
    private PlayerSkin customCape(PlayerInfo instance, Operation<PlayerSkin> original) {
        ...
        if (capeTexture != null || !THClient.hasDevCape(instance.getProfile())) {
            return call;
        }
	...
	*///?} else {
	...
	private void customCape(CallbackInfoReturnable<ResourceLocation> cir) {
		...
		if (THClient.hasDevCape(playerListEntry.getProfile())) {
